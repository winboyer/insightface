...
#     img_paths = ['tests/data/t3.jpg']
    img_paths = ['/root/jinyfeng/datas/Solvay_conference_1927.png']
    for img_path in img_paths:
        img = cv2.imread(img_path)

        for _ in range(1):
            ta = datetime.datetime.now()
            bboxes, kpss = detector.detect(img, 0.6, input_size = (640, 640))
#             bboxes, kpss = detector.detect(img, 0.5)
        ...
        for i in range(bboxes.shape[0]):
            ...
            print('x1,y1,x2,y2,score===========', x1,y1,x2,y2,score)
